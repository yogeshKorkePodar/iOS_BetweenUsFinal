//
//  TeacherPresentHistoryViewController.h
//  BetweenUs
//
...
@interface TeacherPresentHistoryViewController : UIViewController
{
...
@property (weak, nonatomic) IBOutlet UITableView *TeacherPresentHistoryTableView;
