...
-(void) httpPostRequest{
        ...
        NSError *err;
        NSString *str = @"http://115.124.127.238:8021/PodarApp.svc/GetResourceList";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ResourceTableViewCell *Resourcecell = (ResourceTableViewCell *)[tableView dequeueReusableCellWithIdentifier:simpleTableIdentifier];
    if (Resourcecell == nil)
    {
