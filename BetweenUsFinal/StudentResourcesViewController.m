...
-(void) httpPostRequest{
    ...
    if(firstTime==YES){
        ...
        NSError *err;
                NSString *str =app_url @"PodarApp.svc/CycleTestDropDown";
       ...
       _CycleItem.cyc_name = [CycleDetails objectForKey:@"cyc_name"];
        ...
        //Subject List
                NSError *err1;
                NSString *str1 =app_url @"PodarApp.svc/SubjectDropdown";
        ...
        //Topic List
        NSError *err2;
        NSString *str2 =app_url @"PodarApp.svc/GetTopicList";
...
//            lbl1.text= @"No Records Found";
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                NSError *err;
                NSString *str =app_url @"PodarApp.svc/SubjectDropdown";
                str = [str stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
                NSURL *url = [NSURL URLWithString:str];
...
//        NSError *err;
//        NSString *str = app_url @"PodarApp.svc/GetTopicList";
//        str = [str stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
//        NSURL *url = [NSURL URLWithString:str];
//        
//        //Pass The String to server
