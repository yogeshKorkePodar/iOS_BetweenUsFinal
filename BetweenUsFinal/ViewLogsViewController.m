...
-(void)webserviceCall{
    if(firstTime == YES){
        NSString *urlString = app_url @"PodarApp.svc/TopicViewlog";
        ...
        NSString *urlString = app_url @"PodarApp.svc/InsertContentLog";
        ...
        NSString *urlString = app_url @"PodarApp.svc/TopicContentViewlog";
