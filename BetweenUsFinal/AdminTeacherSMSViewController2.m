...
#import "AdminTeacherSMSViewController2.h"
...
@implementation AdminTeacherSMSViewController2
...
-(void)webserviceCall{
    if(firstTime == YES){
        NSString *urlString = app_url @"GetAdminTeacherList";
...
- (IBAction)teacherSMSBtn:(id)sender {
    AdminTeacherSMSViewController2 *adminTeacherSMSViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"AdminTeacherSMS"];
