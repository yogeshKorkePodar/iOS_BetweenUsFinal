        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if([device isEqualToString:@"ipad"]){
                    ...
                    self.badgeCount = [[MKNumberBadgeView alloc] initWithFrame:CGRectMake(self.MessageClick.frame.size.width - 40, -20,48,40)];
                    [self.MessageClick addSubview:self.badgeCount];
                    self.badgeCount.value =  [messageReadCountWithNoInternet count];
                    
                    self.badgeCount = [[MKNumberBadgeView alloc] initWithFrame:CGRectMake(self.announcementClick.frame.size.width - 32, -20,48,40)];
                    ...
                    self.badgeCount = [[MKNumberBadgeView alloc] initWithFrame:CGRectMake(self.MessageClick.frame.size.width - 28, -20,48,40)];
                    [self.MessageClick addSubview:self.badgeCount];
                    self.badgeCount.value =  [messageReadCountWithNoInternet count];
                    
                    self.badgeCount = [[MKNumberBadgeView alloc] initWithFrame:CGRectMake(self.announcementClick.frame.size.width - 28, -20,48,40)];
                    [self.announcementClick addSubview:self.badgeCount];
                    self.badgeCount.value =  [announcementReadCountWithNoInternet count];
...
-(void)webserviceCallForMessage{
    ...
    NSString *urlString = app_url @"GetSentMessageDataTeacher";
...
-(void)webserviceCallForAnnouncement{
    ...
    NSString *urlString = app_url @"GetTeacherAnnouncement";
