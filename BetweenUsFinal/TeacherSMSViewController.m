...
- (void)viewDidLoad {
    ...
    self.teacherSMSdropdownTableView.delegate = self;
    self.teacherSMSdropdownTableView.dataSource = self;
...
-(void) webserviceCall{
    if(loginClick==YES){
        ...
        NSString *urlString = @"http://115.124.127.238:8021/PodarApp.svc/GetTeacherSMSDropDtls";
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                if(!responseData == nil){
                    ...
                    TeacherSMSDropdownStatus = [parsedJsonArray valueForKey:@"Status"];
                    ...
                    NSLog(@"Status:%@",TeacherSMSDropdownStatus);
                    if([TeacherSMSDropdownStatus isEqualToString:@"1"]){
                    ...
                    else if([TeacherSMSDropdownStatus isEqualToString:@"0"]){
                    ...
                    [self.teacherSMSdropdownTableView reloadData];
                    [hud hideAnimated:YES];
                }
            });
        });
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.sectionLabel.backgroundColor =[UIColor colorWithRed:160.0/255.0f green:48/255.0f blue:79/255.0f alpha:1.0];
    cell.shiftlabel.backgroundColor = [UIColor colorWithRed:160.0/255.0f green:48/255.0f blue:79/255.0f alpha:1.0];
    cell.std_div_label.backgroundColor = [UIColor colorWithRed:160.0/255.0f green:48/255.0f blue:79/255.0f alpha:1.0];
    
    cell.wholeview.backgroundColor = [UIColor colorWithRed:160.0/255.0f green:48/255.0f blue:79/255.0f alpha:1.0];
    cell.teacherbtnBg.backgroundColor = [UIColor colorWithRed:150.0/255.0f green:26.0/255.0f blue:60/255.0f alpha:1.0];
    cell.nextBtnBg.backgroundColor = [UIColor colorWithRed:150.0/255.0f green:26.0/255.0f blue:60/255.0f alpha:1.0];
...
{
    //yocomment
//    TeacherSmsStudentListViewController *teacherSmsStudentListViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"TeacherStudentSMSStudentList"];
//    class_id = [[teacherStandardListArray objectAtIndex:indexPath.row]objectForKey:@"class_id"];
//    [[NSUserDefaults standardUserDefaults] setObject:class_id forKey:@"class_Id_TeacherSMS"];
//    [[NSUserDefaults standardUserDefaults] synchronize];
//    
//    [self.navigationController pushViewController:teacherSmsStudentListViewController animated:YES];
